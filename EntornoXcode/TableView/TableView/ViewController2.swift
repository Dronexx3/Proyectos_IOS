...
class ViewController2: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        if let selectedCountry = selectedCountry {
            ...
            case "Peru":
                touristDestinations = ["Machu Picchu"]
            case "Brasil":
                touristDestinations = ["Cristo Redentor"]
            case "Argentina":
                touristDestinations = ["Buenos Aires"]
            default:
                touristDestinations = []
            }
        }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        performSegue(withIdentifier: "pantallatresSegue", sender: selectedDestination)
    }
